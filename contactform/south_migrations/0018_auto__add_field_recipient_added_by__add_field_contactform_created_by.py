...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recipient.added_by'
        db.add_column(u'contactform_recipient', 'added_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ContactForm.created_by'
        db.add_column(u'contactform_contactform', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recipient.added_by'
        db.delete_column(u'contactform_recipient', 'added_by_id')

        # Deleting field 'ContactForm.created_by'
        db.delete_column(u'contactform_contactform', 'created_by_id')
