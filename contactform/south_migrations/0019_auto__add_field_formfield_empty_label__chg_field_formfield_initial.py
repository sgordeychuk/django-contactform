...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FormField.empty_label'
        db.add_column(u'contactform_formfield', 'empty_label',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


        # Changing field 'FormField.initial'
        db.alter_column(u'contactform_formfield', 'initial', self.gf('django.db.models.fields.CharField')(default='', max_length=64))

    def backwards(self, orm):
        # Deleting field 'FormField.empty_label'
        db.delete_column(u'contactform_formfield', 'empty_label')


        # Changing field 'FormField.initial'
        db.alter_column(u'contactform_formfield', 'initial', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))
    ...
    models = {
        ...
        u'contactform.contactformintermediate': {
            'Meta': {'object_name': 'ContactFormIntermediate', '_ormbases': ['cms.CMSPlugin']},
        ...
        u'contactform.formfield': {
            ...
            'css_class': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'empty_label': ('django.db.models.fields.CharField', [], {'max_length': '64', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'initial': ('django.db.models.fields.CharField', [], {'max_length': '64', 'blank': 'True'}),
